...
public class Test {
    public static void main(String[] args) {
        ...
        IAccesoDatos datos = new ArchivoObjeto();
        //IAccesoDatos datos = new ListJugadores();
        VentanaRegistro ventana = new VentanaRegistro(null, false);
        VentanaConsulta consulta = new VentanaConsulta(null, false);
        try{
           
           //System.out.println("Registro de Jugadores");
           datos.registrarJugador(jugadorA);
           datos.registrarJugador(jugadorB);
           datos.registrarJugador(jugadorC);
           datos.registrarJugador(jugadorD);
           datos.registrarJugador(jugadorE);
